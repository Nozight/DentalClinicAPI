package clinic.security.service;

import clinic.dto.AppUserDTO;
import clinic.security.model.AppUser;
import clinic.security.model.AppUserRole;
...
public class DataLoader implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ...
        userRepository.save(new AppUser("user", "user", "user", hashedPassword2, AppUserRole.USER));
    }

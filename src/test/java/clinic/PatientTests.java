...
public class PatientTests {
    ...
    public void findAllPatients() throws ResourseNotFountException {
        ...
        Assertions.assertEquals(patientService.findAll().size(), 3);
        patientService.deleteById(newp1.getId());
        patientService.deleteById(newp2.getId());
    ...
    public void deletePatient() throws ResourseNotFountException {
        ...
        Assertions.assertFalse(patientService.existById(newp3.getId()));
    }
}
